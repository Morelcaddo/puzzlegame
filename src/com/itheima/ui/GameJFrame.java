...
public class GameJFrame extends JFrame implements KeyListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == replayItem) {
            ...
            try {
                ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("save\\" + username + "\\data" + index + ".data"));
            ...
            GameInfo gameInfo;
            try {
                ObjectInputStream ois = new ObjectInputStream(new FileInputStream("save\\" + username + "\\data" + index + ".data"));
                gameInfo = (GameInfo) ois.readObject();
                ois.close();
